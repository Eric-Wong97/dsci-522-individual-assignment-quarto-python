...
![Horse populations for all provinces in Canada from 1906 - 1972. ](../docs/results/horse_pops_plot.png){#fig-horse_pop_plot width=50%}

We can see from @fig-horse_pop_plot that Ontario, Saskatchewan and Alberta 
...
Additionally, note that in @tbl-horse-sd-table we consider the sample standard deviation of the number of horses during the same time span as @fig-horse_pop_plot.

![Horse populations for the province with the largest standard deviation](../docs/results/horse_pops_plot_largest_sd.png){#fig-horse-pop-plots-large-sd width=30%}

In @fig-horse-pop-plots-large-sd we zoom in and look at the province of `{python} largest_sd` which had the largest spread of values in terms of standard deviation.
